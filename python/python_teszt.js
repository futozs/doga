...
function updateFrissFeladatokBox() {
    ...
    box.innerHTML = `
        ...
        ${hasTanulo ? `<div><i class="fa-solid fa-graduation-cap" style="color:#3b82f6;"></i> <strong>Feladatkészítők feladatai</strong> szintén csak Egyéni összeállításban érhetők el — próbáld ki őket, szavazz rájuk, hogy bekerülhessenek a gyakorló feladatok közé!</div>` : ''}
    `;
}
